...
def decide_class(test_data, w_pos, w_neg):
    ...
    for id in test_data.keys():
        ...
        val_class_pos = my_function.logi_sig(val_class_pos) 
        val_class_neg = 1 - my_function.logi_sig(val_class_neg)
        # print(val_class_)
        # val_class_ = my_function.logi_sig(val_class_pos) 
        output_class_ = 'neg' if val_class_neg > val_class_pos else 'pos'
        output_class[tid] = output_class_
        tid += 1
    return output_class